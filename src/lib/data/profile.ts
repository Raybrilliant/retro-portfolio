...
export const profile = {
	...
	heroBadge: 'Reybrilliant OS · Build 2026',
	...
	facts: [
		...
		{ label: 'Current Work', value: 'Pranata Komputer Ahli Pertama at Ministry of Religious Affairs RI' },
		{ label: 'Focus', value: 'Web apps, digital services, performance, efficiency, and maintainability' },
